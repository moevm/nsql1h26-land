...
SORT_FIELDS = {
    "relevance", "created_at", "price", "area_sotki",
    "total_score", "price_per_sotka", "infra_score",
...
def build_plot_filters(filters: dict | None) -> dict:
    ...
    _apply_range_filter(mongo_filters, payload, field="price", min_key="min_price", max_key="max_price")
    _apply_range_filter(mongo_filters, payload, field="area_sotki", min_key="min_area", max_key="max_area")
    _apply_range_filter(mongo_filters, payload, field="price_per_sotka", min_key="min_price_per_sotka", max_key="max_price_per_sotka")
